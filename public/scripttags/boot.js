...
if (xmlhttp.status == 200) {
    console.log("js response text"+xmlhttp.responseText);
}
...
xmlhttp.open("GET", "{{ route('countchatavavtor') }}", true);
xmlhttp.send();
...
document.body.innerHTML += `<button  class="form_btn"><span style=" fill: white;" >
<svg height="12" width="12" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10 2a8 8 0 1 0 0 16 8 8 0 0 0 0-16zm-7.071.929A10 10 0 1 1 17.07 17.07 10 10 0 0 1 2.93 2.93z"/><path d="M11.126 13.002H8.99V11.86c.01-1.966.492-2.254 1.374-2.782.093-.056.19-.114.293-.178.73-.459 1.292-1.038 1.292-1.883 0-.948-.743-1.564-1.666-1.564-.852 0-1.657.398-1.712 1.533H6.305c.06-2.294 1.877-3.487 3.99-3.487 2.306 0 3.894 1.447 3.894 3.488 0 1.382-.695 2.288-1.806 2.952l-.237.144c-.79.475-1.009.607-1.02 1.777v1.142zm.17 2.012a1.344 1.344 0 0 1-1.327 1.328 1.32 1.32 0 0 1-1.227-1.834 1.318 1.318 0 0 1 1.227-.81c.712 0 1.322.592 1.328 1.316h-.001z"/></svg></span></i>Help</button>
...
document.body.innerHTML += `<div style="display:none" class="form_bg">
...
function hidecrosicon() {
    document.getElementsByClassName("notification_main")[0].style.visibility =
        "hidden";
}
